...
# to tell the time
time_i = ["what time is it", "tell me the time", "what's the time", "time please", "current time"]

# to tell the date
date_i = ["what's the date", "what is the date", "tell me the date", "what day is it", "today's date"]

# to search wikipedia
# NOTE: kept deliberately specific so computational queries (e.g. "what is 2+2")
# still fall through to Wolfram Alpha rather than being sent to Wikipedia.
wiki_i = ["search wikipedia", "wikipedia", "tell me about", "who is", "look up"]
